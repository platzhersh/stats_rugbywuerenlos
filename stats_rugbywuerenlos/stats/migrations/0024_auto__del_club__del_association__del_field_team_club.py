...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'stats_team', 'club_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'stats_club', (
            ...
            ('pitch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Location'], null=True, blank=True)),
            ('twitter', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('association', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Association'], null=True, blank=True)),
        ))
        ...
        db.add_column(u'stats_team', 'club',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Club'], null=True, blank=True),
                      keep_default=False)
