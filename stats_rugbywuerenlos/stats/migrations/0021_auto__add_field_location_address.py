...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stats_location', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=599, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.address'
        db.delete_column(u'stats_location', 'address')
