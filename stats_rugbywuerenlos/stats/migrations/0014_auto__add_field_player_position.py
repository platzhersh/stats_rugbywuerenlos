...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.position'
        db.add_column('stats_player', 'position', self.gf('django.db.models.fields.CharField')(default=' ', max_length=30), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Player.position'
        db.delete_column('stats_player', 'position')
