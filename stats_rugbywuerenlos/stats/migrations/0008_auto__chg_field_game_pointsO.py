...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.pointsO'
        db.alter_column('stats_game', 'pointsO', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Game.pointsO'
        db.alter_column('stats_game', 'pointsO', self.gf('django.db.models.fields.IntegerField')())
