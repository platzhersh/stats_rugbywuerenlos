...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Player.birthdate'
        db.alter_column('stats_player', 'birthdate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Player.entry'
        db.alter_column('stats_player', 'entry', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'stats.player': {
            ...
            'entry': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
