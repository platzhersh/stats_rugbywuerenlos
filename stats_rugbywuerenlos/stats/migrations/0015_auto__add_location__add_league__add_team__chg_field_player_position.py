...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stats_location', (
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('stats', ['Location'])

        # Adding model 'League'
        db.create_table('stats_league', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('stats', ['League'])

        # Adding model 'Team'
        db.create_table('stats_team', (
            ('website', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('league', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.League'])),
            ('pitch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stats.Location'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        ...
        db.alter_column('stats_player', 'position', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    
    
    def backwards(self, orm):
        
        # Deleting model 'Location'
        db.delete_table('stats_location')

        # Deleting model 'League'
        db.delete_table('stats_league')

        # Deleting model 'Team'
        db.delete_table('stats_team')

        # Changing field 'Player.position'
        db.alter_column('stats_player', 'position', self.gf('django.db.models.fields.CharField')(max_length=30))
