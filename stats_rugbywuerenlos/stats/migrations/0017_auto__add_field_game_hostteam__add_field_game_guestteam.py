...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.hostteam'
        db.add_column('stats_game', 'hostteam', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='hostteam_set', to=orm['stats.Team']), keep_default=False)

        # Adding field 'Game.guestteam'
        db.add_column('stats_game', 'guestteam', self.gf('django.db.models.fields.related.ForeignKey')(default='1', related_name='guestteam_set', to=orm['stats.Team']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Game.hostteam'
        db.delete_column('stats_game', 'hostteam_id')

        # Deleting field 'Game.guestteam'
        db.delete_column('stats_game', 'guestteam_id')
